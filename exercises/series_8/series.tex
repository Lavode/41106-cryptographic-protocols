...
$0$, right edges being $1$) of the binary representation of $i$. As such $R$
will construct $k_y$ the same way $S$ did, and $c_y \oplus k_y = x_y \oplus k_y
\oplus k_y = x_y$.
